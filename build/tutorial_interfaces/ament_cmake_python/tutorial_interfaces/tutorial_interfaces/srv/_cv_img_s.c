...
bool tutorial_interfaces__srv__cv_img__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.srv._cv_img.CVImg_Request", full_classname_dest, 45) == 0);
  }
  tutorial_interfaces__srv__CVImg_Request * ros_message = _ros_message;
  {  // img
...
{
  /* NOTE(esteve): Call constructor of CVImg_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.srv._cv_img");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CVImg_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool tutorial_interfaces__srv__cv_img__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
  ...
  {  // corners
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->corners.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of CVImg_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.srv._cv_img");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CVImg_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // corners
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "corners");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->corners.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->corners.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->corners.size * sizeof(float));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
