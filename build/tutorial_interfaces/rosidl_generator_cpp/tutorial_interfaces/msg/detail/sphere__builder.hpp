...
class Init_Sphere_centre
{
public:
  Init_Sphere_centre()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Sphere_radius centre(::tutorial_interfaces::msg::Sphere::_centre_type arg)
  {
...
{
  return tutorial_interfaces::msg::builder::Init_Sphere_centre();
}
